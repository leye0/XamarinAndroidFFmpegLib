...
//
    ...
    private const int MUXER_STATE_UNINITIALIZED  = -1;
    private const int MUXER_STATE_INITIALIZED    = 0;
    private const int MUXER_STATE_STARTED        = 1;
    private const int MUXER_STATE_STOPPED        = 2;
