...
using XamarinAndroidFFmpegLib.Interop.Codec.BitStream;
...
namespace XamarinAndroidFFmpegLib.Interop
{
    ...
    {
        public const string AVCODEC_DLL_NAME = "libffmpeg.so";
//		public const string AVCODEC_DLL_NAME = "libavcodec.so";
		...
		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern AVCodec* av_codec_next(AVCodec* codec);

		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern AVOutputFormat* av_oformat_next(AVOutputFormat* format);

		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern AVInputFormat* av_iformat_next(AVInputFormat* format);
		...
		// TODO: Added this entry point as previous is maybe deprecated:
		// REF: See my question at http://stackoverflow.com/questions/30428011/avcodec-open-only-works-with-uncompressed-format
		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern void avcodec_get_context_defaults3(ref AVCodecContext pAVCodecContext, AVCodec *codec);
		...
		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern int avcodec_open2(ref AVCodecContext pAVCodecContext, AVCodec* pAVCodec, AVDictionary **options);
		...
		// TODO: Warning: Testing a signature
		[DllImport(AVCODEC_DLL_NAME, CharSet = CharSet.Ansi)]
		public static extern int avcodec_decode_audio4(ref AVCodecContext pAVCodecContext, AVFrame* pAVFrame,
			[MarshalAs(UnmanagedType.SysInt)]out int gotFrame, ref AVPacket pAVPacket);
        ...
        public static extern int avcodec_decode_video2(ref AVCodecContext pAVCodecContext, AVFrame* pAVFrame,
			[MarshalAs(UnmanagedType.SysInt)]out int got_picture_ptr, ref AVPacket pAVPacket);
		...
		[DllImport(AVCODEC_DLL_NAME, EntryPoint="avcodec_encode_audio2", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		...
		// TODO: Is setting 192000 stupid or am I stupid.
        /// <summary>
        /// 1 second of 48khz 32bit audio in bytes
        /// </summary>
    //    public const int AVCODEC_MAX_AUDIO_FRAME_SIZE = 192000;

		public const int AVCODEC_MAX_AUDIO_FRAME_SIZE = 1920000;
        ...
        */
		...
		public const int AV_CH_STEREO_LEFT            = 0x20000000; ///< Stereo downmix.
		public const int AV_CH_STEREO_RIGHT           = 0x40000000 ;///< See AV_CH_STEREO_LEFT.
