...
namespace XamarinAndroidFFmpegLib.Interop
{
    ...
    public unsafe partial class FFmpeg
    {
        ...
        public const string AVFORMAT_DLL_NAME = "libffmpeg.so";
        ...
        [DllImport(AVFORMAT_DLL_NAME, CharSet = CharSet.Ansi)]
        public static extern AVOutputFormat* av_guess_format(string short_name, string filename,
                                                          string mime_type);
		...
		[DllImport(AVFORMAT_DLL_NAME, EntryPoint = "avformat_alloc_context")]
		static extern AVFormatContext* avformat_alloc_context_internal();

		// TODO: Warning - deprecated, added avformat_alloc_output_context2

		[DllImport(AVFORMAT_DLL_NAME, EntryPoint = "avformat_alloc_context")]
		public static extern AVFormatContext* avformat_alloc_output_context2(AVFormatContext ctx, ref AVOutputFormat oformat, string format_name, string filename);
		...
		{
			AVFormatContext* ptr = avformat_alloc_context_internal();
